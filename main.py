...
url = "https://www.youtube.com/watch?v=5K0uURft3MY"
...
while (True):
    ...
    current_frame_cropped = current_frame[50:500, 450:505,:] # (spiegazione: https://stackoverflow.com/a/58177717/15553356)
    ...
    res_sell = cv2.erode(res_sell, kernel, iterations=2)
